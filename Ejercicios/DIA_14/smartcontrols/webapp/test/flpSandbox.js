					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App SmartControls",
									"targetURL": "#smartcontrols-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"smartcontrols-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartcontrols",
									"url": sap.ui.require.toUrl("smartcontrols")
								}
							}
						}
					}
